...
/* WEBPACK VAR INJECTION */(function($) {/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_instafeed_js__ = __webpack_require__(62);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_owl_carousel__ = __webpack_require__(49);
...
$(document).ready(function () {
    ...
    var feed = new __WEBPACK_IMPORTED_MODULE_0_instafeed_js___default.a({
        ...
        template: '<div class = "image-container">' + '<img src = "{{image}}" width="{{width}}" height="{{height}}">' + '<div class = "media about-container">' + '<figure class = "media-left">' + '<img src = "../images/signage/elements/web_turkey.png" alt="turkey">' + '</figure>' + '<div class = "media-content is-size-2">+ {{likes}}</div>' + '</div>' + '</div>',
