...
/* WEBPACK VAR INJECTION */(function($) {/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_instafeed_js__ = __webpack_require__(13);
...
$(document).ready(function () {
    var $happyNewYear = $('#happy-new-year');
    var $fromSugarNails = $('#from-sugar-nails');
    ...
    var feed = new __WEBPACK_IMPORTED_MODULE_0_instafeed_js___default.a({
        ...
        template: '<div class = "image-container">' + '<nav class = "level">' + '<div class = "level-item has-text-centered">' + '<div>' + '<img src = "../images/signage/elements/web_champagne_bottle.png" class = "star-images" alt="star-images">' + '<p class = "likes">{{likes}} likes</p>' + '</div>' + '</div>' + '</nav>' + '<img src = "{{image}}" width="{{width}}" height="{{height}}">' + '</div>',
