...
$(document).ready(function () {
    ...
    var feed = new __WEBPACK_IMPORTED_MODULE_0_instafeed_js___default.a({
        ...
        template: '<div class = "image-container">' + '<nav class = "level">' + '<div class = "level-item has-text-centered">' + '<div>' + '<img src = "../images/signage/elements/web_candy.png" alt="candy-images">' + '<p class = "likes">{{likes}} likes</p>' + '</div>' + '</div>' + '</nav>' + '<img src = "{{image}}" width="{{width}}" height="{{height}}">' + '</div>',
