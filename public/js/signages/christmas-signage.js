...
$(document).ready(function () {
    ...
    var feed = new __WEBPACK_IMPORTED_MODULE_0_instafeed_js___default.a({
        ...
        template: '<div class = "image-container">' + '<nav class = "level">' + '<div class = "level-item ">' + '<div>' + '<img src = "../images/signage/elements/web_ornament_ball.png" class = "star-images" alt="star-images">' + '<p class = "likes">{{likes}} likes</p>' + '</div>' + '<img src = "{{image}}" width="{{width}}" height="{{height}}">' + '</div>' + '</nav>' + '</div>',
