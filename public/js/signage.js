...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_owl_carousel__ = __webpack_require__(53);
...
$(document).ready(function () {
    ...
    var feed = new __WEBPACK_IMPORTED_MODULE_0_instafeed_js___default.a({
        ...
        template: '<div class = "image-container">' + '<img src = "{{image}}" width="{{width}}" height="{{height}}">' + '<p class = "top-buffer about-container">' + '<span class = "is-size-3">' + '<i class = "fa fa-heart fa-3x heart-icon"></i>{{likes}}' + '</span>' + '</p>' + '</div>',
